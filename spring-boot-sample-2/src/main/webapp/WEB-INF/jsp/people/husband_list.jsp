...
<body>
	<div  style="width:600px;margin-top:50px;margin-left:330px">
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				<c:forEach items="${husbands }" var="husband">
					<tr>
						<td><input type="checkbox" name="ids" value="${husband.hid }" /></td>
						<td>${husband.hid }</td>
						<td>${husband.hname }</td>
						<td>${husband.wife.wname }</td>
						<td>
							<a href="people/husbandDelete/${husband.hid }" class="btn btn-primary">删除</a>
							<a href="people/husband_update/${husband.hid }" class="btn btn-primary">修改</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
