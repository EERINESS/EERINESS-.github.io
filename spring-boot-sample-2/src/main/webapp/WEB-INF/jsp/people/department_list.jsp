		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				<c:forEach items="${departments }" var="department">
					<tr>
						<td><input type="checkbox" name="ids" value="${department.depid }" /></td>
						<td>${department.depid }</td>
						<td>${department.depname }</td>
						<td>
							<a href="department/departmentDelete/${department.depid }" class="btn btn-primary">删除</a>
							<a href="department/department_update/${department.depid }" class="btn btn-primary">修改</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
