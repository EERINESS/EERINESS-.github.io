...
<body>
	<div  style="width:600px;margin-top:50px;margin-left:330px">
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				<c:forEach items="${parents.child }" var="child">
					<tr>
						<td><input type="checkbox" name="ids" value="${child.chid }" /></td>
						<td>${child.chid }</td>
						<td>${child.chname }</td>
						<td>
							<a href="department/departmentDelete/${child.chid }" class="btn btn-primary">删除</a>
							<a href="department/department_update/$child.chid }" class="btn btn-primary">修改</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
